		...
		{{-- <div class="panel"> --}}
			...
			<div class="row">				
				<div class="col-md-6">
					...
					<div class="panel-content">
						<h2 class="heading"><i class="fa fa-square"></i> LAPORAN KEUANGAN PERUSAHAAN</h2>
						<div class="panel-group" id="accordion">
				...
				<div class="col-md-6">
					<div class="panel-content">
						<h2 class="heading"><i class="fa fa-square"></i> KETERANGAN PERUSAHAAN</h2>
						<div class="panel-group" id="accordion">
					...
					<div class="panel-content">
						<h2 class="heading"><i class="fa fa-square"></i>LAPORAN KEUANGAN PERUSAHAAN (LANJUTAN)</h2>
						<div class="panel-group" id="accordion">
