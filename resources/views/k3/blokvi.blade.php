...
<form action="{{ asset(route('entri_data.simpan_blokvi', ['id'=>$k3->id], false)) }}{{-- /entri_data/{{$k3->id}}/simpan_blokvi --}}" id="form_blokvi" method="POST" enctype="multipart/form-data">
{{csrf_field()}}
	...
	<div id="main-content">
		<div class="container-fluid">
			...
			{{-- <ul class="nav nav-pills nav-justified " >
				...
				<li class="nav-item active"><a class="nav-link active" href="/entri_data/{{$k3->id}}/blokvi" ><b>Blok VI</b></a></li>
			</ul> --}}		
	...
	<div class="plan selected-plan profile-section">
						...
						<tr>
							...
							<td>
								<div class="form-group-table {{$errors->has('b6r1k1')  ? 'has-error' : ''}}">
									<input type="text" class="form-control" name="b6r1k1" value="{{$errors->any() ? old('b6r1k1') : $k3->b6r1k1}}">
							...
							<td>
								<div class="form-group-table {{$errors->has('b6r1k2')  ? 'has-error' : ''}}">
									<input type="text" class="form-control" name="b6r1k2" value="{{$errors->any() ? old('b6r1k2') : $k3->b6r1k2}}">
						...
						<tr>
							...
							<td>
								<div class="input-daterange input-group {{$errors->has('b6r2k1') or $errors->has('b6r2k2') ? 'has-error' : ''}}" data-provide="datepicker">
									<input type="text" class="input-sm form-control" name="b6r2k1" value="{{$errors->any() ? old('b6r2k1') : $k3->b6r2k1}}">
									<span class="input-group-addon">s.d.</span>
									<input type="text" class="input-sm form-control" name="b6r2k2" value="{{$errors->any() ? old('b6r2k2') : $k3->b6r2k2}}">									
								</div>
							...
							<td>
								<div class="input-daterange input-group {{$errors->has('b6r2k3') or $errors->has('b6r2k4') ? 'has-error' : ''}}" data-provide="datepicker">
									<input type="text" class="input-sm form-control" name="b6r2k3" value="{{$errors->any() ? old('b6r2k3') : $k3->b6r2k3}}">
									<span class="input-group-addon">s.d.</span>
									<input type="text" class="input-sm form-control" name="b6r2k4" value="{{$errors->any() ? old('b6r2k4') : $k3->b6r2k4}}">									
								</div>
							...
							<td class="text-center">								
								<label class="fancy-checkbox custom-bgcolor-green">
									...
									@else --}}
										...
										<input type="checkbox" name="b6r3k1" value="1" {{($k3->b6r3k1 == '1') ? 'checked' : ''}} ><span>ttd pcl</span>
									{{-- @endif --}}
								</label>
							</td>
							<td class="text-center">
								<label class="fancy-checkbox custom-bgcolor-green">
									...
									@else --}}
										...
										<input type="checkbox" name="b6r3k2" value="1" {{($k3->b6r3k2 == '1') ? 'checked' : ''}}><span>ttd pml</span>
									{{-- @endif --}}
								</label>
							</td>
						</tr>
		...
		{{-- <div class="pager">
			<li><a onclick="document.getElementById('form_blokvi').submit();" href="/entri_data/{{$k3->id}}/blokv">← Blok V</a></li>
...
{{-- <div class="tab-pane fade" id="blokvi"> --}}
