...
<form action="{{ asset(route('entri_data.simpan_blokv', ['id'=>$k3->id], false)) }}{{-- /entri_data/{{$k3->id}}/simpan_blokv --}}" id="form_blokv" method="POST" enctype="multipart/form-data">
{{csrf_field()}}
	...
	<div id="main-content">
		<div class="container-fluid">
			...
			{{-- <ul class="nav nav-pills nav-justified " >
				...
				<li class="nav-item active"><a class="nav-link active" href="/entri_data/{{$k3->id}}/blokv" ><b>Blok V</b></a></li>
			...
			<div class="profile-section">	
				<div class="clearfix">
					<div class="col-md-6">								
						<div class="form-group">
							...
							<div class="form-group-table {{$errors->has('b5r1')  ? 'has-error' : ''}}">
								<input type="text" class="form-control" name="b5r1" maxlength="50" value="{{$errors->any() ? old('b5r1') : $k3->b5r1}}">
								@if ($errors->has('b5r1'))
						...
						<div class="form-group">
							...
							<div class="form-group-table {{$errors->has('b5r2')  ? 'has-error' : ''}}">
								<input type="text" class="form-control" name="b5r2" maxlength="18" value="{{$errors->any() ? old('b5r2') : $k3->b5r2}}">
								@if ($errors->has('b5r2'))
						...
						<div class="form-group">
							<label>Jabatan</label>
							<input type="text" class="form-control" name="b5r3" value="{{$errors->any() ? old('b5r3') : $k3->b5r3}}">
						</div>		
					</div>
					...
					<div class="col-md-6">
						<div class="form-group">
							<label>Tempat</label>
							<div class="form-group-table {{$errors->has('b5r4')  ? 'has-error' : ''}}">
								<input type="text" class="form-control" name="b5r4" value="{{$errors->any() ? old('b5r4') : $k3->b5r4}}">
								@if ($errors->has('b5r4'))
						...
						<div class="form-group">					
							<label>Tanggal</label>
							<div class="input-group date {{$errors->has('b5r5')  ? 'has-error' : ''}}" data-date-autoclose="true" data-provide="datepicker">
								<input type="text" class="form-control" name="b5r5" value="{{$errors->any() ? old('b5r5') : $k3->b5r5}}">
								<span class="input-group-addon"><i class="fa fa-calendar"></i></span>
								@if ($errors->has('b5r5'))
									<span class="help-block">{{$errors->first('b5r5')}}</span>
								@endif
							</div>
						</div>	
						<div class="form-group">
							<label>Mengetahui Kepala Desa</label>
							<div class="form-group-table {{$errors->has('b5r6')  ? 'has-error' : ''}}">
								<input type="text" class="form-control" name="b5r6" value="{{$errors->any() ? old('b5r6') : $k3->b5r6}}">
								@if ($errors->has('b5r6'))
									<span class="help-block">{{$errors->first('b5r6')}}</span>
								@endif
							</div>
						</div>
						<div class="form-group">
							<label>NIP Kepala Desa</label>
							<div class="form-group-table {{$errors->has('b5r7')  ? 'has-error' : ''}}">
								<input type="text" class="form-control" name="b5r7" maxlength="18" value="{{$errors->any() ? old('b5r7') : $k3->b5r7}}">
								@if ($errors->has('b5r7'))
									<span class="help-block">{{$errors->first('b5r7')}}</span>
								@endif
							</div>
						</div>		
					</div>
					<div class="col-md-6">	
						<div class="panel-content">
							...
							@if ($errors->has('b5r8'))
								<span class="help-block"><p class="text-danger">{{$errors->first('b5r8')}}</p></span>
							@endif
						</div>						
					</div>
				</div>
...
{{-- <div class="tab-pane fade" id="blokv"> --}}
