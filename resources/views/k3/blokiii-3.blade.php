...
<form action="{{ asset(route('entri_data.simpan_blokiii_3', ['id'=>$k3->id], false)) }}{{-- /entri_data/{{$k3->id}}/simpan_blokiii_3 --}}" id="form_blokiii_3" method="POST" enctype="multipart/form-data">
{{csrf_field()}}
	...
	<div id="main-content">
		<div class="container-fluid">
			...
			{{-- <ul class="nav nav-pills nav-justified " >
				...
				<li class="nav-item active"><a class="nav-link active" href="/entri_data/{{$k3->id}}/blokiii_3" ><b>Blok III (3)</b></a></li>
	...
	<div class="plan selected-plan profile-section">
		<div class="profile-section">
			<h2 class="page-title text-center">BLOK III. ANGGARAN PENDAPATAN DAN BELANJA PEMERINTAH DESA / NAGARI (Lanjutan 3)<p>( Ribu Rupiah )</p></h2>
		</div>
		<div class="clearfix">
		...
		{{-- <div class="pager">
			<li><a onclick="document.getElementById('form_blokiii_3').submit();" href="/entri_data/{{$k3->id}}/blokiii_2">← Blok III (2)</a></li>
			<li><a onclick="document.getElementById('form_blokiii_3').submit();" href="/entri_data/{{$k3->id}}/blokiii_4">Blok III (4) →</a></li>
		</div> --}}
		<div class="pager">
