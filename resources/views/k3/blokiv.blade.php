...
<form action="{{ asset(route('entri_data.simpan_blokiv', ['id'=>$k3->id], false)) }}{{-- /entri_data/{{$k3->id}}/simpan_blokiv --}}" id="form_blokiv" method="POST" enctype="multipart/form-data">
{{csrf_field()}}
	...
	<div id="main-content">
		<div class="container-fluid">
			...
			{{-- <ul class="nav nav-pills nav-justified " >
				...
				<li class="nav-item active"><a class="nav-link active" href="/entri_data/{{$k3->id}}/blokiv" ><b>Blok IV</b></a></li>
	...
	<div class="plan selected-plan profile-section">
		...
		{{-- <div class="pager">
			<li><a onclick="document.getElementById('form_blokiv').submit();" href="/entri_data/{{$k3->id}}/blokiii_4">← Blok III (4)</a></li>
			<li><a onclick="document.getElementById('form_blokiv').submit();" href="/entri_data/{{$k3->id}}/blokv">Blok V →</a></li>
		</div> --}}
		<div class="pager">
...
{{-- <div class="tab-pane fade" id="blokiv"> --}}
